...
<div id="letter-content" style="padding: 60px; font-family: 'Times New Roman', Times, serif; color: #000; background: #fff; width: 794px; line-height: 1.6; border: 1px solid #eee; margin: auto;">
  <div style="text-align: center; border-bottom: 2px solid #C75A57; padding-bottom: 15px; margin-bottom: 30px;">
    <h2 style="margin: 0; font-size: 24px; text-transform: uppercase; font-weight: bold; letter-spacing: 1px;">OFFICE OF THE SUPERINTENDENT OF POLICE</h2>
    <h3 style="margin: 5px 0; font-size: 20px; color: #C75A57; text-transform: uppercase; font-weight: bold;">CYBER CRIME POLICE STATION</h3>
    <p style="margin: 5px 0; font-size: 14px; font-weight: 600;">Police Commissionerate, Jaipur, Rajasthan - 302001</p>
  </div>
  ...
  <div style="margin-bottom: 30px; font-size: 15px; font-weight: bold; text-align: justify; border-bottom: 1px solid #000; display: inline-block;">
    SUBJECT: NOTICE UNDER SECTION 94/106 BNSS 2023 - REQUEST FOR INFORMATION AND DEBIT FREEZE OF FRAUDULENT ACCOUNT(S).
  </div>

  <div style="margin-bottom: 25px; font-size: 15px; text-align: justify;">
    <p>Respected Sir/Madam,</p>
    <p style="margin-top: 15px;">
      This is to inform you that a cyber crime investigation is currently underway regarding multiple fraudulent transactions. During technical analysis, the following account(s) held in your bank have been identified as involved in the receipt/transfer of misappropriated funds:
    </p>
  </div>
  ...
  <div style="margin-bottom: 30px; font-size: 15px; text-align: justify;">
    ...
    <p style="font-weight: bold; color: #C75A57; border: 1px dashed #C75A57; padding: 15px; background: #fff8f8; text-transform: uppercase; font-size: 13px;">
      FURTHER, YOU ARE REQUESTED TO IMMEDIATELY DEBIT FREEZE THE AFOREMENTIONED ACCOUNT(S) TO PREVENT FURTHER LOSS OF FUNDS.
    </p>
  </div>
