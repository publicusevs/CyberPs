...
<div id="letter-content" style="padding: 60px; font-family: 'Times New Roman', Times, serif; color: #000; background: #fff; width: 794px; line-height: 1.6; border: 1px solid #eee; margin: auto;">
    ...
    <div style="margin-bottom: 25px; font-size: 15px; text-align: justify;">
        ...
        <p style="margin-top: 15px;">
            This is to inform you that a cyber crime investigation is currently underway regarding multiple fraudulent transactions. 
            During technical analysis, the following account(s) held in your bank have been identified as involved in the receipt/transfer of misappropriated funds:
        </p>
    </div>
